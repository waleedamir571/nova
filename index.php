...
<body>
    ...
    <main>
        ...
        <section class="features">
            <div class="container nova-container">
                <div class="row g-4">
                    <div class="col-6 col-lg-3 feature"><span class="sigil sigil-1"></span>
                        <h3>EPIC WORLD</h3>
                    ...
                    <div class="col-6 col-lg-3 feature"><span class="sigil sigil-3"></span>
                        <h3>GRIPPING ADVENTURE</h3>
                        <p>Twists, battles and choices that change everything.</p>
                    </div>
                    <div class="col-6 col-lg-3 feature"><span class="sigil sigil-4"></span>
                        <h3>A SAGA BEGINS</h3>
                        <p>The story of Nova has only just started.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="reviews" class="reviews">
            <div class="container nova-container">
                <h2>WHAT READERS ARE SAYING</h2><span class="ornament"></span>
                <div class="row g-4 review-row">
                    <div class="col-md-4">
                        <article><b>★★★★★</b>
                            <p>“NOVA pulled me in from the first page and never let go. Absolutely unforgettable.”</p>
                            <h4>— Lisa M.</h4><small>Verified Reader</small>
                        </article>
                    </div>
                    <div class="col-md-4">
                        <article><b>★★★★★</b>
                            <p>“A strong, fierce heroine, thrilling plot and a universe I never want to leave.”</p>
                            <h4>— James T.</h4><small>Verified Reader</small>
                        </article>
                    </div>
                    <div class="col-md-4">
                        <article><b>★★★★★</b>
                            <p>“This series is going to be HUGE. I can already feel it. Bring on Book 2!”</p>
                            <h4>— Priya K.</h4><small>Verified Reader</small>
                        </article>
                    </div>
                </div>
            </div>
